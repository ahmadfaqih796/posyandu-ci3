         ...
         <ul class="navbar-nav navbar-nav-hover w-100 justify-content-between">
            <div class="d-lg-flex justify-content-center ">
               <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="<?= base_url("bunda/home") ?>">
               ...
               <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="<?= base_url("bunda/perkembangan_anak") ?>">
               ...
               <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="<?= base_url("bunda/jadwal_posyandu") ?>">
               ...
               <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="<?= base_url("bunda/kegiatan") ?>">
                     <i class="fa fa-clipboard-list me-1"></i>
                     <p class="d-inline text-sm z-index-1 font-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kegiatan">Artikel</p>
                  </a>
               </li>
            </div>
